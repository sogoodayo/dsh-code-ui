...
// --- begin original apply body ---
    ...
    ctx.effect(() => { const tag = document.createElement('style'); tag.setAttribute('data-plugin', 'dsh-code-ui'); tag.textContent = `
      ...
      .cdex-statusbar{display:flex;align-items:center;height:24px;background:var(--cdex-accent-bg,#0f1115);color:var(--cdex-accent-fg,#ffffff);font-size:12px;padding:0 12px;gap:16px;user-select:none;}
