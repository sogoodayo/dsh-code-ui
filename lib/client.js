...
// --- begin original apply body ---
    ...
    function ModeTabs() {
      ...
      return h('div', { className: 'cdex-modebar ' + themeClass(), style: style, onPointerDown: onBarPointerDown },
    ...
    function Workbench() {
      ...
      return h('div', { className: 'cdex-workbench ' + themeClass(), style: style },
